...
class Perfume(Base):
    ...
    # Season categories
    season_spring = Column(Boolean, default=False)
    season_summer = Column(Boolean, default=False)
    season_autumn = Column(Boolean, default=False)
    season_winter = Column(Boolean, default=False)
    ...
    def compute_balance(self):
        self.balance = round((self.selling_price or 0) -
                             (self.purchase_price or 0) -
                             (self.extra_costs or 0), 2)
